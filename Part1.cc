...
int main(){
    ...
    HyblaSocket->TraceConnectWithoutContext("CongestionWindow", MakeBoundCallback (&UpdateCwnd, h1hyblaCongestionWindowFile, timegone));
	timegone += duration;
    //////////////////////////////////
    ...
    WestwoodSocket->TraceConnectWithoutContext("CongestionWindow", MakeBoundCallback (&UpdateCwnd, h2westwoodCongestionWindowFile, timegone));
	timegone += duration;
    /////
	...
	Simulator::Stop(Seconds(timegone));
	Simulator::Run();
